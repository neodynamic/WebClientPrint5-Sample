<%@ Page Title="Print Known File Formats with Encryption" Language="VB" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderScripts" runat="Server">
    ...
    <%=Neodynamic.SDK.Web.WebClientPrint.CreateScript(HttpContext.Current.Request.Url.Scheme & "://" & HttpContext.Current.Request.Url.Host & ":" & HttpContext.Current.Request.Url.Port.ToString & "/WebClientPrintAPI.ashx", HttpContext.Current.Request.Url.Scheme & "://" & HttpContext.Current.Request.Url.Host & ":" & HttpContext.Current.Request.Url.Port.ToString & "/DemoPrintFileWithEncryptionHandler.ashx", HttpContext.Current.Session.SessionID)%>
